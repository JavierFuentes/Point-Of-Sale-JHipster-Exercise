        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('pOSDesignPatternsExerciseApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-pOSDesignPatternsExerciseApp-error');
                                var entityKey = httpResponse.headers('X-pOSDesignPatternsExerciseApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('pOSDesignPatternsExerciseApp.' + fieldError.objectName + '.' + convertedField);
