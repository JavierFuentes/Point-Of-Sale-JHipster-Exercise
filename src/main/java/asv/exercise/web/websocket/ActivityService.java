package asv.exercise.web.websocket;

import asv.exercise.security.SecurityUtils;
import asv.exercise.web.websocket.dto.ActivityDTO;
...
import static asv.exercise.config.WebsocketConfiguration.IP_ADDRESS;
