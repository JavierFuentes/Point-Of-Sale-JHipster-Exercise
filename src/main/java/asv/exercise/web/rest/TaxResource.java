...
public class TaxResource {
    ...
    @RequestMapping(value = "/taxs",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Tax>> getAllTaxs(Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of Taxs");
        Page<Tax> page = taxRepository.findAll(pageable); 
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/taxs");
