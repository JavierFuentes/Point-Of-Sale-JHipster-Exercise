...
class ItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Item entity")
        ...
        .repeat(2) {
            ...
            .post("/api/items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "barcode":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "quantity":null, "price":null, "discountpct":null, "discountamount":null, "baseamount":null, "taxrate":null, "taxamount":null, "totalamount":null}""")).asJSON
            .check(status.is(201))
